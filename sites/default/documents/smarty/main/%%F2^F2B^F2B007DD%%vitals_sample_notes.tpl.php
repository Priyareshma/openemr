<?php /* Smarty version 2.6.33, created on 2022-04-20 09:01:45
         compiled from vitals_sample_notes.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'attr', 'vitals_sample_notes.tpl', 6, false),array('modifier', 'xlt', 'vitals_sample_notes.tpl', 6, false),array('modifier', 'text', 'vitals_sample_notes.tpl', 10, false),array('function', 'xlt', 'vitals_sample_notes.tpl', 7, false),)), $this); ?>
...
?>
        <td  class='historicalvalues'>
            <?php if ($this->_tpl_vars['result']->get_sample_note() != 0): ?>
                <?php echo ((is_array($_tmp=$this->_tpl_vars['result']->get_sample_note())) ? $this->_run_mod_handler('text', true, $_tmp) : text($_tmp)); ?>
